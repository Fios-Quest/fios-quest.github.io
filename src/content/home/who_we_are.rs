...
pub fn WhoWeAre() -> Element {
    rsx! {
        section {
            ...
            HorizontalCollapse {
                SpeechBubble {
                    bubble_type: SpeechBubbleType::Left,
                    H3 { title: "Hi, I'm Fio" }
                    p {{ indoc! {
            ...
            HorizontalCollapse {
                img {
                    src: "https://gravatar.com/userimage/22014166/5694b59bee0539f77cfc290a34300345.jpeg?size=512",
                    alt: "Daniel",
                    class: "circle"
                }
                SpeechBubble {
                    bubble_type: SpeechBubbleType::Right,
